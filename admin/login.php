                    ...
                    <form method="POST">
                        ...
                        <div>
                            <a class="btn btn-default submit">
                                <button type="submit" class="btn btn-primary" style="background-color: #000 ; color: #fff;" name="btnLogin">Đăng nhập</button>
                            </a>
            ...
            <div id="register" class="animate form registration_form">
                <section class="login_content">
                    <form>
                        ...
                        <div>
                            <a class="btn btn-default submit" style="background-color: #000 ; color: #fff;" href="index.html">Submit</a>
                        </div>
